            ...
            VStack(spacing: 14) {
                SettingsSectionCard(title: localized("Startup")) {
                    SettingsCardRow(
                        ...
                        iconColor: .blue,
                        title: localized("Launch ReDuoBar at login"),
                        subtitle: localized("Automatically launch ReDuoBar when you log into your Mac.")
                    ) {
                        Toggle("", isOn: Binding(
                ...
                SettingsSectionCard(title: localized("Interaction")) {
                    SettingsCardRow(
                        ...
                        subtitle: localized("Open ReDuoBar when the pointer moves over the menu bar icon.")
                    ) {
            ...
            VStack(spacing: 14) {
                ...
                SettingsSectionCard(title: localized("Appearance")) {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text(localized("Adjust ReDuoBar to better match your menu bar."))
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                    .padding(.vertical, 2)
...
private final class WindowConfigView: NSView {
    ...
    private func applyWindowTranslucency() {
        ...
        if let themeFrame = window.contentView?.superview {
            let identifier = NSUserInterfaceItemIdentifier("ReDuoBarWindowVisualEffect")
