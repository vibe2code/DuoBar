...
TRANSLATIONS = {
    ...
    "de": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "DuoBar öffnen, wenn der Zeiger über das Menüleistensymbol bewegt wird.",
        "Preview": "Vorschau",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "DuoBar automatisch beim Anmelden an Ihrem Mac starten.",
        "Off": "Aus",
    ...
    "fr": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Ouvrir DuoBar lorsque le pointeur survole l'icône de la barre des menus.",
        "Preview": "Aperçu",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Lancer automatiquement DuoBar à l'ouverture de session sur votre Mac.",
        "Off": "Désactivé",
    ...
    "es": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Abrir DuoBar cuando el puntero pase sobre el icono de la barra de menús.",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Iniciar automáticamente DuoBar al iniciar sesión en el Mac.",
        "Off": "Desactivado",
    ...
    "it": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Apri DuoBar quando il puntatore si sposta sull'icona della barra dei menu.",
        "Preview": "Anteprima",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Avvia automaticamente DuoBar al login del Mac.",
        "Off": "Non attivo",
    ...
    "pt-BR": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Abrir o DuoBar quando o cursor passar sobre o ícone da barra de menus.",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Iniciar o DuoBar automaticamente ao iniciar a sessão no Mac.",
        "Off": "Desativado",
    ...
    "pl": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Otwórz DuoBar, gdy wskaźnik przesunie się nad ikonę paska menu.",
        "Preview": "Podgląd",
        ...
        "Developer": "Deweloper",
        "Automatically launch DuoBar when you log into your Mac.": "Automatycznie uruchamiaj DuoBar po zalogowaniu do Maca.",
        "Off": "Wył.",
    ...
    "uk": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Відкривати DuoBar при наведенні курсора на іконку в рядку меню.",
        "Preview": "Перегляд",
        ...
        "Developer": "Розробник",
        "Automatically launch DuoBar when you log into your Mac.": "Автоматично запускати DuoBar під час входу в систему Mac.",
        "Off": "Вимк.",
    ...
    "tr": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "İşaretçi menü çubuğu simgesinin üzerine geldiğinde DuoBar'ı aç.",
        "Preview": "Önizleme",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Mac'inizde oturum açtığınızda DuoBar'ı otomatik olarak başlatın.",
        "Off": "Kapalı",
    ...
    "el": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "Άνοιγμα του DuoBar όταν ο δείκτης μετακινείται πάνω από το εικονίδιο της γραμμής μενού.",
        ...
        "Automatically launch DuoBar when you log into your Mac.": "Αυτόματη εκκίνηση του DuoBar κατά τη σύνδεση στο Mac.",
        "Off": "Ανενεργό",
    ...
    "ja": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "ポインタがメニューバーアイコンの上を通過したときにDuoBarを開きます。",
        "Preview": "プレビュー",
        ...
        "Developer": "開発者",
        "Automatically launch DuoBar when you log into your Mac.": "MacにログインしたときにDuoBarを自動的に起動します。",
        "Off": "オフ",
    ...
    "ko": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "포인터가 메뉴 막대 아이콘 위로 이동할 때 DuoBar를 엽니다.",
        "Preview": "미리보기",
        ...
        "Developer": "개발자",
        "Automatically launch DuoBar when you log into your Mac.": "Mac에 로그인할 때 DuoBar를 자동으로 실행합니다.",
        "Off": "끔",
    ...
    "ar": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "افتح DuoBar عندما يتحرك المؤشر فوق أيقونة شريط القوائم.",
        "Preview": "معاينة",
        ...
        "Developer": "المطور",
        "Automatically launch DuoBar when you log into your Mac.": "تشغيل DuoBar تلقائيًا عند تسجيل الدخول إلى Mac.",
        "Off": "إيقاف",
    ...
    "hi": {
        ...
        "Open DuoBar when the pointer moves over the menu bar icon.": "जब पॉइंटर मेनू बार आइकन पर जाए तब DuoBar खोलें।",
        "Preview": "पूर्वावलोकन",
        ...
        "Developer": "डेवलपर",
        "Automatically launch DuoBar when you log into your Mac.": "अपने Mac में लॉग इन करते ही DuoBar को स्वचालित रूप से शुरू करें।",
        "Off": "बंद",
    ...
    "zh-Hans": {
        ...
        "Interaction": "交互",
        "Open on Hover": "悬停时打开",
        "Open DuoBar when the pointer moves over the menu bar icon.": "当鼠标指针移到菜单栏图标上方时打开 DuoBar。",
        "Preview": "预览",
        ...
        "Developer": "开发者",
        "Automatically launch DuoBar when you log into your Mac.": "登录 Mac 时自动启动 DuoBar。",
    ...
    "zh-Hant": {
        ...
        "Interaction": "互動",
        "Open on Hover": "懸停時開啟",
        "Open DuoBar when the pointer moves over the menu bar icon.": "當指標移到選單列圖示上方時開啟 DuoBar。",
        "Preview": "預覽",
        ...
        "Developer": "開發者",
        "Automatically launch DuoBar when you log into your Mac.": "登入 Mac 時自動啟動 DuoBar。",
